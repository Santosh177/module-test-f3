...
async function getTimeZone(lat, lon) {
    const request = await fetch(
      `https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${lon}&format=json&apiKey=6b0485b959504fd09447176fca78ecd1`
    );
...
async function getUpdatedTimeZone(input) {
    const request = await fetch(
      `https://api.geoapify.com/v1/geocode/search?text=${input}&format=json&apiKey=6b0485b959504fd09447176fca78ecd1`
    );
    const response = await request.json();
    const timeZoneData = response;
